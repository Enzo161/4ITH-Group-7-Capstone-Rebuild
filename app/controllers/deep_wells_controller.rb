class DeepWellsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @deep_well.save
        AuditLog.new(event: "create", modifier: current_user.email, table_name: "Deep Well", object_name: @deep_well.deep_well_name).save
  ...
  def update
    respond_to do |format| 
      if @deep_well.update(deep_well_params)
        AuditLog.new(event: "update", modifier: current_user.email, table_name: "Deep Well", object_name: @deep_well.deep_well_name).save
